...
var AppleStockSim_1 = require("./AppleStockSim");
function main() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, AppleStockSim_1.establishConnection)()];
                case 1:
                    // Establece una conexión con el clúster de Solana
                    _a.sent();
                    // Determina quién pagará las tarifas
                    return [4 /*yield*/, (0, AppleStockSim_1.establishPayer)()];
                case 2:
                    // Determina quién pagará las tarifas
                    _a.sent();
                    // Verifica si el programa ha sido implementado
                    return [4 /*yield*/, (0, AppleStockSim_1.checkProgram)()];
                case 3:
                    // Verifica si el programa ha sido implementado
                    _a.sent();
                    // Realiza una operación de "vender libro"
                    return [4 /*yield*/, (0, AppleStockSim_1.sharePurchase)()];
                case 4:
                    // Realiza una operación de "vender libro"
                    _a.sent();
                    // Obtiene la cantidad de compras realizadas
                    return [4 /*yield*/, (0, AppleStockSim_1.reportBuys)()];
                case 5:
                    // Obtiene la cantidad de compras realizadas
                    _a.sent();
                    console.log('Éxito');
